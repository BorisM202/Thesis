...
\usepackage[a4paper,lmargin=20mm, textwidth=160mm, tmargin=20mm, textheight=257mm]{geometry} %https://www.overleaf.com/learn/latex/Page_size_and_margins
...
\begin{singlespace}
	...
	\end{doublespace}
	\subfile{sections/front/fundings}
